...
!------------------------------------------------------------------------------
   Subroutine ListtofilePlantgrCrGro(nlayers)
      ...
      !note Alwin Hopf: creates RL1D, RL2D,...RL9D last columns
  ...
  + Len('SNW0C,SNW1C,%LEAF,%STEM,') + Len(Trim(Adjustl(tmp))) ! + Len(',%LEAF,%STEM,')
  ...
  //'LWAD,SWAD,GWAD,RWAD,VWAD,CWAD,G#AD,GWGD,HIAD,PWAD,P#AD,WSPD,WSGD,NSTD,' &
  //'PST1A,PST2A,KSTD,EWSD,LN%D,SH%D,HIPD,PWDD,PWTD,SLAD,CHTD,CWID,NWAD,RDPD,'&
  // 'SNW0C,SNW1C,%LEAF,%STEM,' // Trim(Adjustl(tmp)) !// ',%LEAF,%STEM,'
...
!length= Len('YEAR,DOY,DAS,DAP,FPWAD,PDMCD,AFPWD,ADPWD,PAGED,RTFPW,HARV,RTDPW,' &
!//'HARV_AH') 
length= Len('YEAR,DOY,DAP,NPP,PAGE,NAGE,WTSD,WTSHE,SDNO,SHELN,NR2TIM,HARV_AH,HARVESTED,' &
//'LAST_DAY,COHORT_AGE,RAPID_GROWTH,WTFRT,EO,EOP,TMIN,TMAX')

  Allocate(character(LEN=length) :: Header)

!Header = 'YEAR,DOY,DAS,DAP,FPWAD,PDMCD,AFPWD,ADPWD,PAGED,RTFPW,HARV,RTDPW,' &
!//'HARV_AH'
Header = 'YEAR,DOY,DAP,NPP,PAGE,NAGE,WTSD,WTSHE,SDNO,SHELN,NR2TIM,HARV_AH,HARVESTED,' &
//'LAST_DAY,COHORT_AGE,RAPID_GROWTH,WTFRT,EO,EOP,TMIN,TMAX'
